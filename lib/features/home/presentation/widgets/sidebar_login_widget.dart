...
class SidebarLoginWidget extends StatefulWidget {
  const SidebarLoginWidget({super.key});
  @override
  State<SidebarLoginWidget> createState() => _SidebarLoginWidgetState();
}
class _SidebarLoginWidgetState extends State<SidebarLoginWidget> {
  ...
  void _handleLogin() async {
    ...
    if (mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Login functionality will be connected to Firebase'),
    ...
    return SingleChildScrollView(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Icon(Icons.shield, size: 60, color: Colors.orange[700]),
            const SizedBox(height: 16),
            const Text('FlacronControl', style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: Colors.orange), textAlign: TextAlign.center),
